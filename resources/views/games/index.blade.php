...
<div class="container">
    ...
    @else
        <p class="guest-notice">
            Tu skaties kā viesis. Lai pievienotu spēli, komentārus vai vērtējumus,
            <a href="{{ route('login') }}">pieslēdzies</a> vai
    ...
    <div class="search-box">
        <form method="GET" action="{{ route('games.index') }}">
            <input type="text" name="search" placeholder="Meklēt visās spēlēs..." value="{{ request('search') }}">
            <button type="submit">Meklēt</button>
            <a href="{{ route('games.index') }}">Notīrīt</a>
        </form>
    </div>
    ...
    @endswitch
                    ...
                    <p class="owner">
                        Kolekcija:
                        @if($game->user)
                            <a href="{{ route('collections.show', $game->user) }}">
                                {{ $game->user->name }}
                            </a>
                        @else
                            Nezināms
